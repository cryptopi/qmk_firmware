 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  L1  |Y/COPY|U/CUT |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSp   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |J/PSTE|   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------| Hyper|           | LGui |------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        // right hand
             ...
             TG(SYMB),    TD(Y_COPY),   TD(U_CUT),  KC_I,   KC_O,   KC_P,             KC_BSLS,
                          KC_H,   TD(J_PASTE),  KC_K,   KC_L,   KC_SCOLON,GUI_T(KC_QUOT),
             KC_LGUI,KC_N,   KC_M,  KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSHIFT,
